...
function simplevisitorcounter_init() {
		register_setting('zeitplaner-group', 'simplevisitorcounter_exclude_ips',  'iplist');
    register_setting('zeitplaner-group', 'simplevisitorcounter_display_footer', 'intval');
    register_setting('zeitplaner-group', 'simplevisitorcounter_display_credit', 'intval');
    register_setting('zeitplaner-group', 'simplevisitorcounter_style');
    register_setting('zeitplaner-group', 'simplevisitorcounter_data', 'intval');
    register_setting('zeitplaner-group', 'simplevisitorcounter_align');
    register_setting('zeitplaner-group', 'simplevisitorcounter_count_admin', 'intval');
    register_setting('zeitplaner-group', 'simplevisitorcounter_count_404', 'intval');
    register_setting('zeitplaner-group', 'simplevisitorcounter_pad_zeros', 'intval'); 
    register_setting('zeitplaner-group', 'simplevisitorcounter_count_only_unique', 'intval');
}
...
function simplevisitorcounter_menu() {
  add_options_page('Hit Counter Options', 'Hit Counter', 'administrator', 'zeitplaner', 'simplevisitorcounter_options');
}
...
function simplevisitorcounter_options() {
    ...
    <form method="post" action="options.php">
        <?php settings_fields( 'zeitplaner-group' ); ?>
        <?php
            $data = file_array(WP_CONTENT_DIR . '/plugins/zeitplaner/styles/');
    ...
    <?php
                foreach ($style as $name) {
                	...
                	<tr>
                		...
                		<img src='<?php echo WP_PLUGIN_URL?>/zeitplaner/styles/<?php echo $style_name . '/' . $name . '/'; ?>0.gif'>
                		<img src='<?php echo WP_PLUGIN_URL?>/zeitplaner/styles/<?php echo $style_name . '/' . $name . '/'; ?>1.gif'>
                		<img src='<?php echo WP_PLUGIN_URL?>/zeitplaner/styles/<?php echo $style_name . '/' . $name . '/'; ?>2.gif'>
                		<img src='<?php echo WP_PLUGIN_URL?>/zeitplaner/styles/<?php echo $style_name . '/' . $name . '/'; ?>3.gif'>
                		<img src='<?php echo WP_PLUGIN_URL?>/zeitplaner/styles/<?php echo $style_name . '/' . $name . '/'; ?>4.gif'>
                		</td>
                	</tr>
                    <?php
                }
